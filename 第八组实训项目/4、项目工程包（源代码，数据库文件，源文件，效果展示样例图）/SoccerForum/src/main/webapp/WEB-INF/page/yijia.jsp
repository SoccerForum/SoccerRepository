...
<body>
    ...
    <div class="content-top">
		...
		<div class="active clear listel contour-2"><ol class='list-none metlist'>
			<div><font size="3" face="黑体" color="#AD0000"><b>&nbsp;&nbsp;意甲专区</b></font></div>
...
<li class='list '><span class='time'>2012-07-16</span><a href='#' >为什么企业要建多国语言网站？</a></li>
<li class='list '><span class='time'>2012-07-16</span><a href='#' >如何获取MetInfo网站管理系统商业授权？</a></li></ol></div>
	</div>
                <div class="content">
            ...
            <div class="right-sidebar">
            	 <div class="info-box">                                   
                     <div class="sub-nav-cell"> 
                     	<br />
                        <h3 class="orange">主版</h3>
                        <ul class="sub-nav-box">
                <li><a href="#">足球话题区</a></li>
                <li><a href="#">足球场</a></li>
                <li><a href="#">妖人银河系</a></li>
            </ul>
            <br />
            <h3 class="orange">英超</h3>
                        <ul class="sub-nav-box">
                <li><a href="#">英超专区</a></li>
                <li><a href="#">曼联专区</a></li>
                <li><a href="#">阿森纳专区</a></li>
                <li><a href="#">利物浦专区</a></li>
                <li><a href="#">切尔西专区</a></li>
                <li><a href="#">曼城专区</a></li>
                <li><a href="#">热刺专区</a></li>
                <li><a href="#">英冠专区</a></li>              
            </ul>
            <br />
            <h3 class="orange">西甲</h3>
                        <ul class="sub-nav-box">
                <li><a href="#">西甲专区</a></li>
                <li><a href="#">皇马专区</a></li>
                <li><a href="#">巴萨专区</a></li>
                <li><a href="#">马竞专区</a></li>
                <li><a href="#">埃瓦尔官方专</a></li>
                <li><a href="#">瓦伦西亚专区</a></li>
                <li><a href="#">塞维利亚官方</a></li>                
            </ul>
            <br />
            <h3 class="orange">意甲</h3>
                        <ul class="sub-nav-box">
                <li><a href="#">意甲专区</a></li>
                <li><a href="#">米兰专区</a></li>
                <li><a href="#">国米专区</a></li>
                ...
                <li><a href="#">罗马专区</a></li>               
                        ...
                        <br />
            <h3 class="orange">德甲</h3>
                        <ul class="sub-nav-box">
                <li><a href="#">德意志城堡</a></li>
                <li><a href="#">拜仁专区</a></li>
                <li><a href="#">多特蒙德专区</a></li>
                <li><a href="#">沙尔克04专区</a></li>
                <li><a href="#">勒沃库森专区</a></li>
                <li><a href="#">不莱梅专区</a></li>              
            </ul>
                        <br />
            <h3 class="orange">法甲</h3>
                        <ul class="sub-nav-box">
                <li><a href="#">法兰西足球</a></li>
                <li><a href="#">巴黎专区</a></li>             
            </ul>
                        <br />
            <h3 class="orange">其他</h3>
                        <ul class="sub-nav-box">
                <li><a href="#">欧洲非主流联</a></li>
                <li><a href="#">美洲足球-美洲</a></li>
                <li><a href="#">足球壁纸</a></li>
                <li><a href="#">看球藏图阁</a></li>
                <li><a href="#">足球装备</a></li>
                <li><a href="#">FIFA足球世界</a></li>             
            </ul>
